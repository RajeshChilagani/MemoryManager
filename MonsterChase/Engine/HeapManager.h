...
namespace HeapManagerProxy
{
	...
	public:
		...
		void _Collect();
		bool _IsAllocated(void * i_ptr);
		bool _Contains(void * i_ptr);
		void _ShowFreeBlocks();
		void _ShowOutstandingAllocations();
		...
		static const int s_MinumumToLeave = sizeof(BlockDesc);
	private:
