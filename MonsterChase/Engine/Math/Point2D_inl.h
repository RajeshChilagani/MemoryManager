...
inline Point2D::Point2D(int i_x, int i_y):m_x(i_x),m_y(i_y){}
inline Point2D::Point2D(float i_x, float i_y) : m_x(static_cast<int>(i_x)), m_y(static_cast<int>(i_y)) {}
inline Point2D::Point2D(const Point2D& i_Point2D) : m_x(i_Point2D.x()), m_y(i_Point2D.y()) {}
inline int Point2D::x(void) const
{
	return m_x;
}
inline int Point2D::y(void) const
{
	return m_y;
}
inline void Point2D::x(int i_x)
{
	m_x = i_x;
}
inline void Point2D::y(int i_y)
{
	m_y = i_y;
}
...
{
	m_x *= static_cast<int>(i_val);
	m_y *= static_cast<int>(i_val);
	return *this;
}
//Test this 
inline Point2D & Point2D::operator/=(const Point2D & i_rhs)
...
{
	return Point2D(static_cast<int>(i_lhs.x() * i_rhs), static_cast<int>(i_lhs.y() * i_rhs));
}
//
inline Point2D Math::operator/(const Point2D & i_lhs, const Point2D & i_rhs)
{
